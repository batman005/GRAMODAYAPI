...
describe("Report", function() {
    ...
    */
    describe("/POST reports", () => {
        ...
        // Without Price
        it('it should not POST a report without Price', (done) => {
            let report = {
                userID: "user-1",
                marketID: "market-1",
                cmdtyID: "cmdty-1",
    ...
    describe("/GET report", () => {
        ...
        it('it should get the reports for a an known cmdtyID', (done) => {
            ...
            report.save((err,report) => {
                ...
                res.body.report[0].should.have.property('price').eql(report.price);
                done();
            });
            })
        });
        ...
        it('it should update already existing cmdtyID-marketID', async () => {
            ...
            get('/reports?cmdtyID=cmdty-1').
                ...
                res.body.report[0].should.have.property('price').eql(((report1.price / report1.convFctr) + (report2.price / report2.convFctr)) / 2 );
            });
        });
        })
